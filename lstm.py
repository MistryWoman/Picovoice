...
class LSTM:
    def __init__(self, chat_to_idx, idx_to_char, vocab_size, seq_len=25,
                 n_h = 100, epochs = 10, lr = 0.01, beta1 = 0.9,
                 beta2 = 0.999):
        self.char_to_idx = char_to_idx
        self.idx_to_char = idx_to_char
        self.vocab_size = vocab_size
        self.n_h = n_h # no of units in hidden layer
        ...
        # cell gate
        self.params['Wc'] = np.random.rand(self.n_h, self.n_h +
                                           self.vocab_size)* std
        ...
        # initialize gradients and adam optimizer parameters
        self.grads = {}
        self.adam_params = {}
...
def forward_step(self, x, h_prev, c_prev):
    ...
    # here is where the CIFG change happens
    # c = f * c_prev + i * c_bar
